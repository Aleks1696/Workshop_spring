    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li class="active"><a href="${pageContext.request.contextPath}/master/account"><fmt:message key="jsp.header.home.button"/></a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="${pageContext.request.contextPath}/master/account/language/en">English</a></li>
                        <li><a href="${pageContext.request.contextPath}/master/account/language/ua">Українська</a></li>
                    </ul>
                </li>
            </ul>
